...
to EavesDroid. The module is able to successful recover 54.18\% of the words with at most
5 labeling errors. This accuracy is low compared to 94.54\% in the case of Harvard sentences
because there are 257 words in the article not present in the dictionary.
This demonstrates the practical utility 
